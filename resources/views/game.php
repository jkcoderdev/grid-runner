...
<html>
    <head>
        ...
        <?php styles('preloader', 'main') ?>
        <?php scripts('preloader', 'game', 'main') ?>
    </head>
    <body>
            ...
            <section class="sidebar sidebar-left menu">
                <section class="box">
                    ...
                    <div class="buttons">
                        ...
                        <?php else: ?>
                            <button class="btn" onclick="location.href='/api/logout'">
                                <span>Log out</span>
            ...
            <section class="sidebar sidebar-right menu">
                <section class="box">
                    ...
                    <div class="updates">
                        <h1>1.7.0</h1>
                        <ul>
                            <li>Refreshed back-end codebase</li>
                        </ul>
                        <h1>1.6.0</h1>
                        <ul>
        ...
        <footer class="footer">
            <div class="info">
                ...
                <?php  if(isset($_SESSION['user_id'])): ?>
                    <div><a href="/api/logout">Log out</a></div>
                <?php else: ?>
